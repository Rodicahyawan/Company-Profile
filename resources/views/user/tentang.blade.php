...
<body>
    ...
    <div class="full-width-image">
        <img src="{{ asset('storage/' . $firstItem->gambar) }}" alt="Ruang Tunggu" class="full-image" />
    </div>

    <!-- Deskripsi Tentang Kami -->
    <div class="tentang-deskripsi">
        {!! nl2br(e($firstItem->deskripsi)) !!}
    </div>
    ...
    <div class="container-custom">
        <div class="card-container">
            ...
            @foreach($tentangData as $item) <!-- Iterasi melalui semua item kecuali yang pertama -->
                <a class="card-link">
                    <div class="card">
                        <img src="{{ asset('storage/' . $item->gambar) }}" class="card-img-top" alt="{{ $item->keunggulan }}">
                        <div class="card-body">
                            <h5 class="card-title">{{ $item->keunggulan }}</h5>
